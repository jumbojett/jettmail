 ...
 * @author mjett@mitre.org - gabe@fijiwebdesign.com
 * @url http://mitre.org http://www.fijiwebdesign.com/
...
class MimeMailParser {
     ...
     * @return array
     */
    public function extractEmails($header) {
    ...
    public function extractEmail($header) {
        list ($first_email) = $this->extractEmails($header);
